...
def _restore_saved_state(payload: dict[str, Any], runtime: FishRuntime) -> FishState:
    ...
    state.setdefault("plan_summary", "")
    state.setdefault("sources", [])
    state.setdefault("research_artifacts", [])
    state.setdefault("research_batches", [])
    state.setdefault("latest_research_batch", {})
    state.setdefault("research_assessments", [])
    state.setdefault("latest_research_assessment", {})
    ...
    state.setdefault("test_notes", "")
    state.setdefault("verification_status", "not_started")
    state.setdefault("verified", False)
    state.setdefault("code_dirty", False)
